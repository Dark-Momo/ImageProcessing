//Generated:2022-05-26 17:52:14// 39-531
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6409782 || '',
    GUID: window.ftGUID_6409782 || '99999999999',
    confID: window.ftConfID_6409782 || '0',
    ftReturn: window.ftReturn_6409782 || '',
    keyword: window.ftKeyword_6409782 || '',
    ftId: window.ftId_6409782 || '',
    imp: window.ftImp6409782,
    ftImpId: window.ftImp6409782 && window.ftImp6409782.impID || '',
    gdpr: window.ftImp6409782 && window.ftImp6409782.gdpr || '',
    gdpr_consent: window.ftImp6409782 && window.ftImp6409782.gdpr_consent || '',
    gdpr_pd: window.ftImp6409782 && window.ftImp6409782.gdpr_pd || '',
    us_privacy: window.ftImp6409782 && window.ftImp6409782.us_privacy || '',
    campaignID: '178722',
    cID: '158349',
    pID: '6409782',
    creativeID: '3923299',
    ...
    clickTags: [
      "http://servedby.flashtalking.com/click/8/178722;6409782;3923299;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409782;3923299;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409782;3923299;213;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409782;3923299;214;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409782;3923299;215;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409782;3923299;216;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409782;3923299;217;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]"
    ],
    placementDescription: 'BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x600',
    width: 300,
    height: 600,
    ...
    divID: 'ftdiv6409782',
    phID: 'ftpos6409782',
    frameID: 'ftframe6409782',
    expID: 'ftexpframe6409782',
    altImgID: 'ftalt6409782',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/178722;6409782;3923299;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]',
    altImg: 'http://servedby.flashtalking.com/imp/8/178722;6409782;204;gif;DBM;BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x600/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/178722;6409782;271;pixel;DBM;BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x600/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/640/6409782/3923299/js/j-6409782-3923299.js',
    file: 'http://cdn.flashtalking.com/158349/3923299/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?222895850-6409782;3923299;',
    adVis: true ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_6409782 || '',
    segmentList: window.ftSegmentList_6409782 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6409782 && window.ftImp6409782.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6409782') && /^https:/.test(document.getElementById('ftscript_m6409782').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6409782'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6409782'],
      ['ftcfid', 'ftConfID_6409782'],
      ['fttime', 'ftTimestamp_6409782'],
      ['ftsection', 'ftSection_6409782'],
      ['ftcustom', 'ftCustom_6409782'],
      ['ft_id', 'ftId_6409782'],
      ['ftimpid', 'ftImp6409782', 'impID'],
      ['gdpr', 'ftImp6409782', 'gdpr'],
      ['gdpr_consent', 'ftImp6409782', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6409782', 'gdpr_pd'],
      ['us_privacy', 'ftImp6409782', 'us_privacy']
    ]
  };
...
(function(ft){
    ...
    ft.viewableImpression = "http://servedby.flashtalking.com/imp/8/178722;6409782;202;pixel;DBM;BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x600/?ft_creative=3923299&ft_configuration=";
    ft.viewableConversion = "true"==="true";
