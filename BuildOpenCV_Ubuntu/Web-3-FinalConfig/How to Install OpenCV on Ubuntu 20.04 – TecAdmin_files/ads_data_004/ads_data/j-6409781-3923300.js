//Generated:2022-05-26 17:52:27// 39-531
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6409781 || '',
    GUID: window.ftGUID_6409781 || '99999999999',
    confID: window.ftConfID_6409781 || '0',
    ftReturn: window.ftReturn_6409781 || '',
    keyword: window.ftKeyword_6409781 || '',
    ftId: window.ftId_6409781 || '',
    imp: window.ftImp6409781,
    ftImpId: window.ftImp6409781 && window.ftImp6409781.impID || '',
    gdpr: window.ftImp6409781 && window.ftImp6409781.gdpr || '',
    gdpr_consent: window.ftImp6409781 && window.ftImp6409781.gdpr_consent || '',
    gdpr_pd: window.ftImp6409781 && window.ftImp6409781.gdpr_pd || '',
    us_privacy: window.ftImp6409781 && window.ftImp6409781.us_privacy || '',
    campaignID: '178722',
    cID: '158349',
    pID: '6409781',
    creativeID: '3923300',
    ...
    clickTags: [
      "http://servedby.flashtalking.com/click/8/178722;6409781;3923300;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409781;3923300;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409781;3923300;213;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409781;3923300;214;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409781;3923300;215;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409781;3923300;216;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]","http://servedby.flashtalking.com/click/8/178722;6409781;3923300;217;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]"
    ],
    placementDescription: 'BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x250',
    width: 300,
    height: 250,
    ...
    divID: 'ftdiv6409781',
    phID: 'ftpos6409781',
    frameID: 'ftframe6409781',
    expID: 'ftexpframe6409781',
    altImgID: 'ftalt6409781',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/178722;6409781;3923300;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.bestbuy.com/?ref=RT166&loc=BAN_[CUSTOM]',
    altImg: 'http://servedby.flashtalking.com/imp/8/178722;6409781;204;gif;DBM;BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x250/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/178722;6409781;271;pixel;DBM;BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x250/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/640/6409781/3923300/js/j-6409781-3923300.js',
    file: 'http://cdn.flashtalking.com/158349/3923300/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?222895854-6409781;3923300;',
    adVis: true ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_6409781 || '',
    segmentList: window.ftSegmentList_6409781 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6409781 && window.ftImp6409781.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6409781') && /^https:/.test(document.getElementById('ftscript_m6409781').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6409781'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6409781'],
      ['ftcfid', 'ftConfID_6409781'],
      ['fttime', 'ftTimestamp_6409781'],
      ['ftsection', 'ftSection_6409781'],
      ['ftcustom', 'ftCustom_6409781'],
      ['ft_id', 'ftId_6409781'],
      ['ftimpid', 'ftImp6409781', 'impID'],
      ['gdpr', 'ftImp6409781', 'gdpr'],
      ['gdpr_consent', 'ftImp6409781', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6409781', 'gdpr_pd'],
      ['us_privacy', 'ftImp6409781', 'us_privacy']
    ]
  };
...
(function(ft){
    ...
    ft.viewableImpression = "http://servedby.flashtalking.com/imp/8/178722;6409781;202;pixel;DBM;BestBuyPZNFY23COMPMSFTSurfaceAODesktopDBM300x250/?ft_creative=3923300&ft_configuration=";
    ft.viewableConversion = "true"==="true";
